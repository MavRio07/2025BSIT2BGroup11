...
<div class="services-section">
    ...
    <div class="services-grid">
        <div class="service-card emergency-card" onclick="location.href='help.php'" tabindex="0" role="button" aria-label="Emergency Hotline - Get immediate help">
        ...
        <div class="service-card safety-card" onclick="showSafetyPlan()" tabindex="0" role="button" aria-label="Create a Safety Plan">
            <div class="card-header">
        ...
        <div class="service-card shelter-card" onclick="showShelterInfo()" tabindex="0" role="button" aria-label="Find a Shelter">
            <div class="card-header">
