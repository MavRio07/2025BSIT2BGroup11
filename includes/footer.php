                    ...
                    <form id="loginForm" method="POST" action="login.php">
                        ...
                        <div id="userFields">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="modalNameInput" placeholder="Enter your full name">
                            </div>
                            
                            <div class="form-group">
                                <label for="modalEmailInput">Email Address</label>
                                <input type="email" name="email" id="modalEmailInput" placeholder="Enter your email address">
                            </div>
                        </div>
