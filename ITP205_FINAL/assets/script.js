...
function submitLogin() {
  ...
  if (userType === "admin") {
    ...
    if (!username) {
      showFieldError(usernameField, "Please enter your username")
      hasErrors = true
    }
...
function toggleLoginFields() {
  ...
  if (adminRadio && adminRadio.checked) {
    ...
    // Clear user fields and remove required attributes
    ...
    // Clear admin fields and remove required attributes
    const usernameInput = document.getElementById("modalUsernameInput")
    const passwordInput = document.getElementById("modalPasswordInput")
    if (usernameInput) {
      usernameInput.value = ""
